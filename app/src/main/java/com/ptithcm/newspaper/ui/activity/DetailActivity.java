...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String articleThumbnail = getIntent().getStringExtra("ARTICLE_THUMBNAIL");
        
        currentArticleLink = articleUrl;
        ...
        if (articleUrl != null) {
            ...
            article.setThumbnail(articleThumbnail);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, 2, 0, "Chia sẻ").setIcon(android.R.drawable.ic_menu_share).setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            if (currentArticleLink != null) {
                ...
                article.setTitle(getIntent().getStringExtra("ARTICLE_TITLE"));
                article.setThumbnail(getIntent().getStringExtra("ARTICLE_THUMBNAIL"));
                preferencesManager.addFavorite(article);
                Toast.makeText(this, "Đã thêm vào yêu thích!", Toast.LENGTH_SHORT).show();
            }
            return true;
        } else if (item.getItemId() == 2) {
            String articleUrl = currentArticleLink;
